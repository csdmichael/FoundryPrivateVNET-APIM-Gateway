...
resource "azurerm_linux_web_app" "bot" {
  ...
  site_config {
    application_stack {
      ...
      app_command_line = "/bin/bash /home/site/wwwroot/startup.sh"
  }
