...
@Component({
  selector: 'app-test-apim',
  templateUrl: './test-apim.page.html',
  styleUrls: ['./test-apim.page.scss'],
  standalone: false,
})
export class TestApimPage implements OnInit, OnDestroy {
  ...
  run() {
    ...
    this.loading = true;
    this.result = null;
    this.api.testApim(this.selectedPrompt, this.uc.activeKey).subscribe({
